...
function Footer() {
  return (
    <div className="w-full p-[20px] bg-[#28438E] sm:min-w-[85vw] md:px-12 smm:px-4 ">
      <div className=" max-w-[1536px] mx-auto flex justify-around  md:flex-col md:justify-center">
        ...
        <div className="w-1/3 md:w-full">
          <p className="text-xl text-md flex  pl-28 md:pl-0 md:py-6 smm:text-[15px]  text-white md:text-center font-bold">
            Информация на данном сайте носит информационный характер и не
            является офертой.
          </p>
        </div>
        <div className="md:w-full md:ml-0  ml-[104px] sm:ml-0 ">
          <div className="header_technical_support flex flex-col md:justify-between md:flex-row  ">
            <div className="header_connection flex items-center  gap-3">
              ...
              <div className="header_connection_title">
                <p className="font-bold text-base text-white text-md smm:text-[11px] ">
                  ЗВОНИТЕ
                </p>
                <span className="text-[#FFCE45] text-md smm:text-[11px] ">+78432126064</span>
              </div>
            </div>
            <div className="header_support flex items-center gap-3 mt-5 smm:mt-0 smm:ml-8  md:mt-[50px]">
              ...
              <div className="header_support_title">
                ...
                <p className="text-[#FFCE45] text-md   smm:text-[11px]">
